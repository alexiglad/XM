...
class Transformer(nn.Module):
    ...
    def forward(self, embeddings: torch.Tensor, start_pos: int, learning = False, mask = "causal"):
        """
        ...
        Args:
            ...
            start_pos (int): Starting position for attention caching.
            mask: "causal" for causal mask (default), None for bidirectional, or a custom mask tensor.
        ...
        """
        if not learning:
            with torch.no_grad(): # use no_grad instead of inference_mode due to inference_mode causing issues
