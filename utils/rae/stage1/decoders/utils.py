# Vendored via the official RAE implementation (https://github.com/bytetriper/RAE,
# MIT License, Copyright (c) 2025 Boyang Zheng). The ViTMAEConfig definition below is
# itself derived from HuggingFace Transformers (Apache License 2.0, Copyright 2022
# Facebook AI and The HuggingFace Inc. team). See utils/rae/ATTRIBUTION.md.
