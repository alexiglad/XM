...
class ImageNetDataset(Dataset):
    def __init__(self, hparams, split, transform):
        ...
        orig_labels = list(self.ds["label"])
        self.num_classes = len(set(orig_labels))
        print(f"ImageNet {split} dataset loaded with {len(self.ds)} samples and {self.num_classes} classes")
